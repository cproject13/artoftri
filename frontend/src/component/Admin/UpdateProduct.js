...
const UpdateProduct = ({ history, match }) => {
  ...
  const Stock = Number(SmallStock) + Number(MediumStock) + Number(LargeStock)
  ...
  useEffect(() => {
    if (product && product._id !== productId) {
      ...
      setSmallStock(product.SmallStock)
      setMediumStock(product.MediumStock)
      setLargeStock(product.LargeStock)
  ...
  const updateProductSubmitHandler = (e) => {
    ...
    myForm.set("SmallStock", SmallStock);
    myForm.set("MediumStock", MediumStock);
    myForm.set("LargeStock", LargeStock);
          ...
          >
            ...
            <div>
              ...
              >
                ...
                {categories.map((cate) => (
                  <option key={cate} value={cate} disabled>
                    {cate}
                  </option>
                ))}
              </select>
